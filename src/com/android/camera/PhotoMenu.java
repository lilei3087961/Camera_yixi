...
public class PhotoMenu extends PieController
    ...
    private String[] mOtherKeys2_front;
    private String[] mOtherKeys3_front;
   ...
   @Override
    ...
    protected void initializePopup() {
     ...
     ComboPreferences mPreferences = ComboPreferences.get(mActivity);
     ...
     if(isFront){
         popup2.initialize(mPreferenceGroup, mOtherKeys2_front);
     }else{
     ...
     if(isFront){
         popup3.initialize(mPreferenceGroup, mOtherKeys3_front);
     }else{
