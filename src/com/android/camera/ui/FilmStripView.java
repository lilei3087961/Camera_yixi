...
public class FilmStripView extends ViewGroup implements BottomControlsListener {
    ...
    //add by lilei begin
    YixiColorEffectSettingPopup mColorEffectPop;
    //add by lilei end
...
/* remove for AP-434 by lilei
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        //add by lilei begin
        Log.i("lilei", "FilmStripView.onTouchEvent()");
        mColorEffectPop = (YixiColorEffectSettingPopup)findViewById(R.id.color_effect_pop);
        if(mColorEffectPop!=null && mColorEffectPop.getVisibility() == View.VISIBLE && CameraUtil.pointInView(ev.getX(),ev.getY(),mColorEffectPop)){
            Log.i("lilei", "~~~~ FilmStripView.onTouchEvent()  111");
            return true;
        }
        //add by lilei end
