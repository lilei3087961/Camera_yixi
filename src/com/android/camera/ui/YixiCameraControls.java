...
public class YixiCameraControls extends RotatableLayout {
    ...
    private View mColorEffect;
    private View mPauseButton;
//    private View mSetMore;

    public YixiCameraControls(Context context, AttributeSet attrs) {
        super(context, attrs);
        setMeasureAllChildren(true);
    }

    public YixiCameraControls(Context context) {
        super(context);
        setMeasureAllChildren(true);
    }
    ...
    public void onFinishInflate() {
        ...
        mColorEffect = findViewById(R.id.btn_color_effect);
        mPauseButton = findViewById(R.id.video_pause);
//        mSetMore = findViewById(R.id.setmore_button);
        //modify by lilei end
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //topRight(mPreview, l, t, r, b);  //modify by lilei
        if (size > 0) {
        ...
        */
        //mSwitcher.layout(r-100, 0, r, 400); //for test
        toLeft(mPreview, shutter, rotation);
        if(mColorEffect != null){        //for camera mode
        	toRight(mColorEffect, shutter, rotation);
        }else if(mPauseButton != null){  //for video mode
        	toRight(mPauseButton, shutter, rotation);
        }
//        FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams)mSetMore.getLayoutParams();
//        Log.i("lilei","mSetMore leftMargin:"+lp.leftMargin+" rightMargin:"+lp.rightMargin+" topMargin:"+lp.topMargin
//        		+" bottomMargin:"+lp.bottomMargin+" gravity:"+lp.gravity);
        //modify by lilei end
    ...
    private void adjustBackground() {
        if(mBackgroundView == null) //add by lilei
            return;
        int rotation = getUnifiedRotation();
