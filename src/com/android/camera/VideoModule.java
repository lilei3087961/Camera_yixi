...
public class VideoModule implements CameraModule,
    ...
    private void initializeVideoControl() {
        ...
        mUI.initDropPreference(mPreferenceGroup);
    }
    ...
    public void onOrientationChanged(int orientation) {
        ...
        //if(CameraActivity.YIXI_LOG_ON)
        	Log.i("lilei", "VideoModule.onOrientationChanged() orientation:"+orientation+" roundOrientation:"+roundOrientation);
        mUI.setOrientationIndicator2(roundOrientation,false);
        //add by lilei end
    }
    ...
    public void onShutterButtonClick() {
        ...
        Log.i("lilei", "onShutterButtonClick() 00");
        ...
        if (stop) {
        	...
        	Log.i("lilei", "onShutterButtonClick() 11 startVideoRecording()");
            startVideoRecording();
        }
    ...
    private void getDesiredPreviewSize() {
        ...
        if (mParameters.getSupportedVideoSizes() == null) {
            ...
            Size optimalSize = CameraUtil.getOptimalPreviewSize(mActivity, sizes,
                    (double) mProfile.videoFrameWidth / mProfile.videoFrameHeight,true);
    ...
    public void onResumeAfterSuper() {
    	Log.i("lilei","onResumeAfterSuper() 000");
        mUI.enableShutter(false);
        mZoomValue = 0;
        ...
        mUI.setListener(mParameters, this);
        keepScreenOnAwhile();
        ...
        Log.i("lilei","onResumeAfterSuper() 111");
    }
    ...
    private void startVideoRecording() {
        ...
        Log.i("lilei", "startVideoRecording 111");
        ...
        Log.i("lilei", "startVideoRecording 222");
    ...
    private boolean stopVideoRecording() {
        ...
        if (mMediaRecorderRecording) {
            ...
            int stopOrientation  = CameraUtil.getDisplayRotation(mActivity);
            if(stopOrientation != 180){
                stopOrientation = 0;
            }
            mUI.setOrientationIndicator(stopOrientation, true);
            //modify by lilei end
            keepScreenOnAwhile();
    ...
    private void setCameraParameters() {
        ...
        //remove for video rotate preview error by lilei begin
//        boolean flag = false;
//        if (mPreviewing) {
//            stopPreview();
//            flag = true;
...
//            startPreview();
//        }
        //remove for video rotate preview error by lilei end
