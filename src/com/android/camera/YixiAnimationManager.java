...
public class YixiAnimationManager {
    ...
    public void startCaptureAnimation(final View view) {
        ...
        ObjectAnimator slide = ObjectAnimator.ofFloat(view, "translationX", 0f, slideDistance)
                .setDuration(YixiAnimationManager.SLIDE_DURATION);
        slide.setStartDelay(YixiAnimationManager.SHRINK_DURATION + YixiAnimationManager.HOLD_DURATION);

        ObjectAnimator translateY = ObjectAnimator.ofFloat(view, "translationY",
                parentView.getHeight() / 2 - centerY, 0f)
                .setDuration(YixiAnimationManager.SHRINK_DURATION);
    ...
    */
    public void startFlashAnimation(final View flashOverlay) {
        ...
        mFlashAnim = ObjectAnimator.ofFloat(flashOverlay, "alpha",
                YixiAnimationManager.FLASH_ALPHA_START, YixiAnimationManager.FLASH_ALPHA_END);
        mFlashAnim.setDuration(YixiAnimationManager.FLASH_DURATION);
