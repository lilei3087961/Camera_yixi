...
public class Storage {
    ...
    public static final long LOW_STORAGE_THRESHOLD_BYTES = 50000000 * 3; //update for AP-394
    ...
    private static long getSDCardAvailableSpace() {
        if (SDCard.instance().isWriteable()) {
            try {
                ...
                Log.i(TAG,"lilei !!!!getSDCardAvailableSpace() error e:"+e+" trace:"+Log.getStackTraceString(e));
            }
            return UNKNOWN_SIZE;
        }
        return UNKNOWN_SIZE;
